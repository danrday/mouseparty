defmodule MousepartyWeb.UserAuthTest do
  use MousepartyWeb.ConnCase, async: true

  alias Mouseparty.Accounts
  alias MousepartyWeb.UserAuth
  import Mouseparty.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, MousepartyWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      MousepartyWeb.Endpoint.subscribe(live_socket_id)
